...
type GetGroupMembersInfoResp struct {
	CommResp
	MemberList []*crazy_server_sdk.GroupMemberFullInfo `json:"-"`
...
type GetJoinedGroupListResp struct {
	CommResp
	GroupInfoList []*crazy_server_sdk.GroupInfo `json:"-"`
	Data          []map[string]interface{}      `json:"data" swaggerignore:"true"`
}
...
type CreateGroupResp struct {
	CommResp
	GroupInfo crazy_server_sdk.GroupInfo `json:"-"`
	Data      map[string]interface{}     `json:"data" swaggerignore:"true"`
}
...
type GetGroupApplicationListResp struct {
	CommResp
	GroupRequestList []*crazy_server_sdk.GroupRequest `json:"-"`
	Data             []map[string]interface{}         `json:"data" swaggerignore:"true"`
}
