...
import (
	"context"
	jsonData "crazy_server/internal/utils"
...
// @Produce json
// @Success 0 {object} api.CreateDepartmentResp{data=crazy_server_sdk.Department}
...
func CreateDepartment(c *gin.Context) {
	...
	req := &rpc.CreateDepartmentReq{DepartmentInfo: &crazy_server_sdk.Department{}}
...
func UpdateDepartment(c *gin.Context) {
	...
	req := &rpc.UpdateDepartmentReq{DepartmentInfo: &crazy_server_sdk.Department{}}
	utils.CopyStructFields(req, &params)
	utils.CopyStructFields(req.DepartmentInfo, &params)
	err, opUserID := token_verify.ParseTokenGetUserID(c.Request.Header.Get("token"), req.OperationID)
	req.OpUserID = opUserID
...
// @Produce json
// @Success 0 {object} api.GetSubDepartmentResp{data=[]crazy_server_sdk.Department}
// @Failure 500 {object} api.Swagger500Resp "errCode为500 一般为服务器内部错误"
// @Failure 400 {object} api.Swagger400Resp "errCode为400 一般为参数输入错误, token未带上等"
...
func CreateOrganizationUser(c *gin.Context) {
	...
	req := &rpc.CreateOrganizationUserReq{OrganizationUser: &crazy_server_sdk.OrganizationUser{}}
	utils.CopyStructFields(req, &params)
...
func UpdateOrganizationUser(c *gin.Context) {
	...
	req := &rpc.UpdateOrganizationUserReq{OrganizationUser: &crazy_server_sdk.OrganizationUser{}}
	utils.CopyStructFields(req, &params)
	utils.CopyStructFields(req.OrganizationUser, &params)
	err, opUserID := token_verify.ParseTokenGetUserID(c.Request.Header.Get("token"), req.OperationID)
	req.OpUserID = opUserID
...
func CreateDepartmentMember(c *gin.Context) {
	...
	req := &rpc.CreateDepartmentMemberReq{DepartmentMember: &crazy_server_sdk.DepartmentMember{}}
	utils.CopyStructFields(req, &params)
...
// @Produce json
// @Success 0 {object} api.GetUserInDepartmentResp{data=crazy_server_sdk.UserInDepartment}
// @Failure 500 {object} api.Swagger500Resp "errCode为500 一般为服务器内部错误"
// @Failure 400 {object} api.Swagger400Resp "errCode为400 一般为参数输入错误, token未带上等"
...
func UpdateUserInDepartment(c *gin.Context) {
	...
	req := &rpc.UpdateUserInDepartmentReq{DepartmentMember: &crazy_server_sdk.DepartmentMember{}}
	utils.CopyStructFields(req.DepartmentMember, &params)
	utils.CopyStructFields(req, &params)
	err, opUserID := token_verify.ParseTokenGetUserID(c.Request.Header.Get("token"), req.OperationID)
	req.OpUserID = opUserID
...
// @Produce json
// @Success 0 {object} api.GetDepartmentMemberResp{data=[]crazy_server_sdk.UserDepartmentMember}
// @Failure 500 {object} api.Swagger500Resp "errCode为500 一般为服务器内部错误"
// @Failure 400 {object} api.Swagger400Resp "errCode为400 一般为参数输入错误, token未带上等"
