...
func GetUsersInfoFromCache(c *gin.Context) {
	...
	var publicUserInfoList []*crazy_server_sdk.PublicUserInfo
	for _, v := range RpcResp.UserInfoList {
		publicUserInfoList = append(publicUserInfoList,
			&crazy_server_sdk.PublicUserInfo{UserID: v.UserID, Nickname: v.Nickname, FaceURL: v.FaceURL, Gender: v.Gender, Ex: v.Ex})
	}
...
// @Produce json
// @Success 0 {object} api.GetUsersInfoResp{Data=[]crazy_server_sdk.PublicUserInfo}
...
func UpdateUserInfo(c *gin.Context) {
	...
	req := &rpc.UpdateUserInfoReq{UserInfo: &crazy_server_sdk.UserInfo{}}
...
// @Produce json
// @Success 0 {object} api.GetSelfUserInfoResp{data=crazy_server_sdk.UserInfo}
// @Failure 500 {object} api.Swagger500Resp "errCode为500 一般为服务器内部错误"
// @Failure 400 {object} api.Swagger400Resp "errCode为400 一般为参数输入错误, token未带上等"
...
func GetUsers(c *gin.Context) {
	...
	reqPb.Pagination = &crazy_server_sdk.RequestPagination{ShowNumber: req.ShowNumber, PageNumber: req.PageNumber}
