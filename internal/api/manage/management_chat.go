...
func newUserSendMsgReq(params *api.ManagementSendMsgReq) *pbChat.SendMsgReq {
	...
	pbData := pbChat.SendMsgReq{
		...
		MsgData: &crazy_server_sdk.MsgData{
...
func ManagementSendMsg(c *gin.Context) {
	...
	resp := api.ManagementSendMsgResp{
		...
		ResultList: crazy_server_sdk.UserSendMsgResp{ServerMsgID: RpcResp.ServerMsgID, ClientMsgID: RpcResp.ClientMsgID, SendTime: RpcResp.SendTime}}
