...
import (
	...
	rpc "crazy_server/pkg/proto/friend"
...
// @Produce json
// @Success 0 {object} api.GetBlackListResp{data=[]crazy_server_sdk.PublicUserInfo}
...
func GetBlacklist(c *gin.Context) {
	...
	for _, v := range RpcResp.BlackUserInfoList {
		black := crazy_server_sdk.PublicUserInfo{}
...
// @Produce json
// @Success 0 {object} api.GetFriendListResp{data=[]crazy_server_sdk.FriendInfo}
// @Failure 500 {object} api.Swagger500Resp "errCode为500 一般为服务器内部错误"
// @Failure 400 {object} api.Swagger400Resp "errCode为400 一般为参数输入错误, token未带上等"
...
// @Produce json
// @Success 0 {object} api.GetFriendApplyListResp{data=[]crazy_server_sdk.FriendRequest}
// @Failure 500 {object} api.Swagger400Resp "errCode为500 一般为服务器内部错误"
// @Failure 400 {object} api.Swagger400Resp "errCode为400 一般为参数输入错误, token未带上等"
...
// @Produce json
// @Success 0 {object} api.GetSelfApplyListResp{data=[]crazy_server_sdk.FriendRequest}
// @Failure 500 {object} api.Swagger500Resp "errCode为500 一般为服务器内部错误"
// @Failure 400 {object} api.Swagger400Resp "errCode为400 一般为参数输入错误, token未带上等"
