...
import (
	...
	rpc "crazy_server/pkg/proto/group"
...
// @Produce json
// @Success 0 {object} api.GetGroupMembersInfoResp{data=[]crazy_server_sdk.GroupMemberFullInfo}
// @Failure 500 {object} api.Swagger500Resp "errCode为500 一般为服务器内部错误"
// @Failure 400 {object} api.Swagger400Resp "errCode为400 一般为参数输入错误, token未带上等"
...
// @Produce json
// @Success 0 {object} api.GetGroupAllMemberResp{data=[]crazy_server_sdk.GroupMemberFullInfo}
// @Failure 500 {object} api.Swagger500Resp "errCode为500 一般为服务器内部错误"
// @Failure 400 {object} api.Swagger400Resp "errCode为400 一般为参数输入错误, token未带上等"
...
// @Produce json
// @Success 0 {object} api.GetJoinedGroupListResp{data=[]crazy_server_sdk.GroupInfo}
// @Failure 500 {object} api.Swagger500Resp "errCode为500 一般为服务器内部错误"
// @Failure 400 {object} api.Swagger400Resp "errCode为400 一般为参数输入错误, token未带上等"
...
// @Produce json
// @Success 0 {object} api.CreateGroupResp{data=crazy_server_sdk.GroupInfo}
// @Failure 500 {object} api.Swagger500Resp "errCode为500 一般为服务器内部错误"
// @Failure 400 {object} api.Swagger400Resp "errCode为400 一般为参数输入错误, token未带上等"
...
func CreateGroup(c *gin.Context) {
	...
	req := &rpc.CreateGroupReq{GroupInfo: &crazy_server_sdk.GroupInfo{}}
...
// @Produce json
// @Success 0 {object} api.GetGroupApplicationListResp{data=[]crazy_server_sdk.GroupRequest}
// @Failure 500 {object} api.Swagger500Resp "errCode为500 一般为服务器内部错误"
// @Failure 400 {object} api.Swagger400Resp "errCode为400 一般为参数输入错误, token未带上等"
...
//func transferGroupInfo(input []*crazy_server_sdk.GroupInfo) []*api.GroupInfoAlias {
...
func SetGroupInfo(c *gin.Context) {
	...
	req := &rpc.SetGroupInfoReq{GroupInfoForSet: &crazy_server_sdk.GroupInfoForSet{}}
