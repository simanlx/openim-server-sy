...
func setOpUserInfo(opUserID, groupID string, groupMemberInfo *crazy_server_sdk.GroupMemberFullInfo) error {
...
func setGroupInfo(groupID string, groupInfo *crazy_server_sdk.GroupInfo) error {
...
func setGroupMemberInfo(groupID, userID string, groupMemberInfo *crazy_server_sdk.GroupMemberFullInfo) error {
...
func setGroupOwnerInfo(groupID string, groupMemberInfo *crazy_server_sdk.GroupMemberFullInfo) error {
...
func setPublicUserInfo(userID string, publicUserInfo *crazy_server_sdk.PublicUserInfo) error {
	user, err := imdb.GetUserByUserID(userID)
	if err != nil {
		return utils.Wrap(err, "")
	}
...
func GroupCreatedNotification(operationID, opUserID, groupID string, initMemberList []string) {
	GroupCreatedTips := crazy_server_sdk.GroupCreatedTips{Group: &crazy_server_sdk.GroupInfo{},
		OpUser: &crazy_server_sdk.GroupMemberFullInfo{}, GroupOwnerUser: &crazy_server_sdk.GroupMemberFullInfo{}}
	...
	for _, v := range initMemberList {
		var groupMemberInfo crazy_server_sdk.GroupMemberFullInfo
...
func GroupInfoSetNotification(operationID, opUserID, groupID string, groupName, notification, introduction, faceURL string, needVerification, applyMemberFriend, lookMemberInfo *wrapperspb.Int32Value) {
	GroupInfoChangedTips := crazy_server_sdk.GroupInfoSetTips{Group: &crazy_server_sdk.GroupInfo{}, OpUser: &crazy_server_sdk.GroupMemberFullInfo{}}
...
func GroupMutedNotification(operationID, opUserID, groupID string) {
	tips := crazy_server_sdk.GroupMutedTips{Group: &crazy_server_sdk.GroupInfo{},
		OpUser: &crazy_server_sdk.GroupMemberFullInfo{}}
...
func GroupCancelMutedNotification(operationID, opUserID, groupID string) {
	tips := crazy_server_sdk.GroupCancelMutedTips{Group: &crazy_server_sdk.GroupInfo{},
		OpUser: &crazy_server_sdk.GroupMemberFullInfo{}}
	if err := setGroupInfo(groupID, tips.Group); err != nil {
		log.Error(operationID, "setGroupInfo failed ", err.Error(), groupID)
		return
...
func GroupMemberMutedNotification(operationID, opUserID, groupID, groupMemberUserID string, mutedSeconds uint32) {
	tips := crazy_server_sdk.GroupMemberMutedTips{Group: &crazy_server_sdk.GroupInfo{},
		OpUser: &crazy_server_sdk.GroupMemberFullInfo{}, MutedUser: &crazy_server_sdk.GroupMemberFullInfo{}}
...
func GroupMemberInfoSetNotification(operationID, opUserID, groupID, groupMemberUserID string) {
	tips := crazy_server_sdk.GroupMemberInfoSetTips{Group: &crazy_server_sdk.GroupInfo{},
		OpUser: &crazy_server_sdk.GroupMemberFullInfo{}, ChangedUser: &crazy_server_sdk.GroupMemberFullInfo{}}
	if err := setGroupInfo(groupID, tips.Group); err != nil {
		log.Error(operationID, "setGroupInfo failed ", err.Error(), groupID)
		return
	}
...
func GroupMemberCancelMutedNotification(operationID, opUserID, groupID, groupMemberUserID string) {
	tips := crazy_server_sdk.GroupMemberCancelMutedTips{Group: &crazy_server_sdk.GroupInfo{},
		OpUser: &crazy_server_sdk.GroupMemberFullInfo{}, MutedUser: &crazy_server_sdk.GroupMemberFullInfo{}}
	if err := setGroupInfo(groupID, tips.Group); err != nil {
		log.Error(operationID, "setGroupInfo failed ", err.Error(), groupID)
		return
...
func JoinGroupApplicationNotification(req *pbGroup.JoinGroupReq) {
	JoinGroupApplicationTips := crazy_server_sdk.JoinGroupApplicationTips{Group: &crazy_server_sdk.GroupInfo{}, Applicant: &crazy_server_sdk.PublicUserInfo{}}
...
func MemberQuitNotification(req *pbGroup.QuitGroupReq) {
	MemberQuitTips := crazy_server_sdk.MemberQuitTips{Group: &crazy_server_sdk.GroupInfo{}, QuitUser: &crazy_server_sdk.GroupMemberFullInfo{}}
...
func GroupApplicationAcceptedNotification(req *pbGroup.GroupApplicationResponseReq) {
	GroupApplicationAcceptedTips := crazy_server_sdk.GroupApplicationAcceptedTips{Group: &crazy_server_sdk.GroupInfo{}, OpUser: &crazy_server_sdk.GroupMemberFullInfo{}, HandleMsg: req.HandledMsg}
...
func GroupApplicationRejectedNotification(req *pbGroup.GroupApplicationResponseReq) {
	GroupApplicationRejectedTips := crazy_server_sdk.GroupApplicationRejectedTips{Group: &crazy_server_sdk.GroupInfo{}, OpUser: &crazy_server_sdk.GroupMemberFullInfo{}, HandleMsg: req.HandledMsg}
...
func GroupOwnerTransferredNotification(req *pbGroup.TransferGroupOwnerReq) {
	GroupOwnerTransferredTips := crazy_server_sdk.GroupOwnerTransferredTips{Group: &crazy_server_sdk.GroupInfo{}, OpUser: &crazy_server_sdk.GroupMemberFullInfo{}, NewGroupOwner: &crazy_server_sdk.GroupMemberFullInfo{}}
...
func GroupDismissedNotification(req *pbGroup.DismissGroupReq) {
	tips := crazy_server_sdk.GroupDismissedTips{Group: &crazy_server_sdk.GroupInfo{}, OpUser: &crazy_server_sdk.GroupMemberFullInfo{}}
...
func MemberKickedNotification(req *pbGroup.KickGroupMemberReq, kickedUserIDList []string) {
	MemberKickedTips := crazy_server_sdk.MemberKickedTips{Group: &crazy_server_sdk.GroupInfo{}, OpUser: &crazy_server_sdk.GroupMemberFullInfo{}}
...
func MemberInvitedNotification(operationID, groupID, opUserID, reason string, invitedUserIDList []string) {
	MemberInvitedTips := crazy_server_sdk.MemberInvitedTips{Group: &crazy_server_sdk.GroupInfo{}, OpUser: &crazy_server_sdk.GroupMemberFullInfo{}}
...
func MemberEnterNotification(req *pbGroup.GroupApplicationResponseReq) {
	MemberEnterTips := crazy_server_sdk.MemberEnterTips{Group: &crazy_server_sdk.GroupInfo{}, EntrantUser: &crazy_server_sdk.GroupMemberFullInfo{}}
