...
import (
	...
	pbCache "crazy_server/pkg/proto/cache"
	pbConversation "crazy_server/pkg/proto/conversation"
...
func (s *groupServer) CreateGroup(ctx context.Context, req *pbGroup.CreateGroupReq) (*pbGroup.CreateGroupResp, error) {
	...
	resp := &pbGroup.CreateGroupResp{GroupInfo: &crazy_server_sdk.GroupInfo{}}
...
func (s *groupServer) GetJoinedGroupList(ctx context.Context, req *pbGroup.GetJoinedGroupListReq) (*pbGroup.GetJoinedGroupListResp, error) {
	...
	for _, v := range joinedGroupList {
		var groupNode crazy_server_sdk.GroupInfo
...
func (s *groupServer) GetGroupAllMember(ctx context.Context, req *pbGroup.GetGroupAllMemberReq) (*pbGroup.GetGroupAllMemberResp, error) {
	...
	if groupInfo.GroupType != constant.SuperGroup {
		...
		for _, v := range memberList {
			var node crazy_server_sdk.GroupMemberFullInfo
...
func (s *groupServer) GetGroupMembersInfo(ctx context.Context, req *pbGroup.GetGroupMembersInfoReq) (*pbGroup.GetGroupMembersInfoResp, error) {
	...
	resp.MemberList = []*crazy_server_sdk.GroupMemberFullInfo{}
	for _, userID := range req.MemberList {
		...
		var memberNode crazy_server_sdk.GroupMemberFullInfo
...
func (s *groupServer) GetGroupApplicationList(_ context.Context, req *pbGroup.GetGroupApplicationListReq) (*pbGroup.GetGroupApplicationListResp, error) {
	...
	for _, v := range reply {
		node := crazy_server_sdk.GroupRequest{UserInfo: &crazy_server_sdk.PublicUserInfo{}, GroupInfo: &crazy_server_sdk.GroupInfo{}}
...
func (s *groupServer) GetGroupsInfo(ctx context.Context, req *pbGroup.GetGroupsInfoReq) (*pbGroup.GetGroupsInfoResp, error) {
	...
	groupsInfoList := make([]*crazy_server_sdk.GroupInfo, 0)
	for _, groupID := range req.GroupIDList {
		...
		var groupInfo crazy_server_sdk.GroupInfo
...
func (s *groupServer) GetGroups(_ context.Context, req *pbGroup.GetGroupsReq) (*pbGroup.GetGroupsResp, error) {
	...
	resp := &pbGroup.GetGroupsResp{
		...
		Pagination: &crazy_server_sdk.ResponsePagination{CurrentPage: req.Pagination.PageNumber, ShowNumber: req.Pagination.ShowNumber},
	}
	if req.GroupID != "" {
		...
		for _, v := range groups {
			group := &pbGroup.CMSGroup{GroupInfo: &crazy_server_sdk.GroupInfo{}}
...
func (s *groupServer) GetGroupMembersCMS(_ context.Context, req *pbGroup.GetGroupMembersCMSReq) (*pbGroup.GetGroupMembersCMSResp, error) {
	...
	for _, groupMember := range groupMembers {
		member := crazy_server_sdk.GroupMemberFullInfo{}
	...
	resp.Pagination = &crazy_server_sdk.ResponsePagination{
